$(function () {
    ...
    $("#jqGrid").jqGrid({
        ...
        datatype: "json",
        colModel: [
            {label: '商品ID', name: 'goodsId', index: 'goodsId', width: 50, key: true},
            {label: '商品后台ID', name: 'goodsBackId', index: 'goodsBackId', width: 50},
            {label: '店铺ID', name: 'storeId', index: 'storeId', sortable: false, width: 80},
            {label: '添加时间', name: 'createDate', index: 'createDate', sortable: false, width: 80}
        ],
        height: 485,
        rowNum: 10,
        rowList: [10, 30, 50],
